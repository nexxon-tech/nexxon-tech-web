            ...
            <div className="w-full px-4">
              ...
              >
                <h1 className="mb-5 text-3xl font-bold leading-tight text-black sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight dark:text-white">
                  Custom Web Application & Mobile App Development Company
                </h1>
                <p className="mb-12 text-base !leading-relaxed text-body-color sm:text-lg md:text-xl dark:text-body-color-dark">
                  Elevate your digital experience with Nexxon Tech — where
              ...
              >
                <div className="relative h-full w-full max-w-lg p-4 md:h-auto">
                  <div className="relative rounded-lg bg-white p-4 shadow md:p-8 dark:bg-gray-800">
                    ...
                    <div className="items-center justify-between space-y-4 pt-0 sm:flex sm:space-y-0">
                      ...
                      <div className="items-center space-y-4 sm:flex sm:space-x-4 sm:space-y-0">
                        <button
                          id="close-modal"
                          type="button"
                          className="w-full rounded-lg border border-gray-200 bg-white px-4 py-2 text-sm font-medium text-gray-500 hover:bg-gray-100 hover:text-gray-900 focus:z-10 focus:outline-none focus:ring-4 focus:ring-primary-300 sm:w-auto dark:border-gray-500 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white dark:focus:ring-gray-600"
                        >
                          Cancel
                        </button>
                        <button
                          id="confirm-button"
                          type="button"
                          className="w-full rounded-lg bg-primary-700 px-4 py-2 text-center text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 sm:w-auto dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
                        >
                          Confirm
                        </button>
                      </div>
