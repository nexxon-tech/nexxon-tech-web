      ...
      <div className="translations-content-container">
        <div className="container">
          <div
            ...
            id="en"
          >
            <h1 className="mb-4 text-[40px] font-bold leading-[60px]">
              Privacy Policy
            </h1>
            <p className="mb-4 leading-7">Last updated: December 30, 2023</p>
            ...
            <h2 className="mb-4 text-[32px] font-bold leading-[48px]">
              Interpretation and Definitions
            </h2>
            <h3 className="mb-4 text-2xl font-bold">Interpretation</h3>
            <p className="mb-4 leading-7">
            ...
            <h3 className="mb-4 text-2xl font-bold">Definitions</h3>
            <p className="mb-4 leading-7">
            ...
            <ul className="list-disc ps-10">
              ...
              <li className="mb-4 leading-7">
                <p className="mb-4 leading-7">
                  ...
                  Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                  &quot;Our&quot; in this Agreement) refers to Nexxon Tech.
                </p>
              </li>
              <li className="mb-4 leading-7">
                <p className="mb-4 leading-7">
              ...
              <li className="mb-4 leading-7">
                <p className="mb-4 leading-7">
                  <strong>Website</strong> refers to Nexxon Tech, accessible
                  from&nbsp;
                  <a
                    href="https://www.nexxontech.com/"
                    target="_blank"
                    rel="noreferrer"
                    className="text-blue-700 underline"
                  >
                    https://www.nexxontech.com/
                  </a>
                </p>
              </li>
              <li className="mb-4 leading-7">
            ...
            <h3 className="mb-4 text-2xl font-bold">Types of Data Collected</h3>
            <h4 className="mb-4 text-xl font-bold leading-8">Personal Data</h4>
            <p className="mb-4 leading-7">
            ...
            <ul className="list-disc ps-10">
              <li className="mb-4 leading-7">
                <p className="mb-4 leading-7">Email address</p>
              </li>
              <li className="mb-4 leading-7">
                <p className="mb-4 leading-7">First name and last name</p>
              </li>
              <li className="mb-4 leading-7">
                <p className="mb-4 leading-7">Phone number</p>
              </li>
              <li className="mb-4 leading-7">
                <p className="mb-4 leading-7">Usage Data</p>
              </li>
            </ul>
            <h4 className="mb-4 text-xl font-bold leading-8">Usage Data</h4>
            <p className="mb-4 leading-7">
            ...
            <h4 className="mb-4 text-xl font-bold leading-8">
            ...
            <ul className="list-disc ps-10">
              <li className="mb-4 leading-7">
                ...
                <p className="mb-4 leading-7">Type: Session Cookies</p>
                <p className="mb-4 leading-7">Administered by: Us</p>
                <p className="mb-4 leading-7">
              ...
              <li className="mb-4 leading-7">
                ...
                <p className="mb-4 leading-7">Type: Persistent Cookies</p>
                <p className="mb-4 leading-7">Administered by: Us</p>
                <p className="mb-4 leading-7">
            ...
            <ul className="list-disc ps-10">
              <li className="mb-4 leading-7">Comply with a legal obligation</li>
              <li className="mb-4 leading-7">
            ...
            <ul className="list-disc ps-10">
              <li className="mb-4 leading-7">
                <p className="mb-4 leading-7">
                  By email: contact@nexxontech.com
                </p>
              </li>
              <li className="mb-4 leading-7">
                <p className="mb-4 leading-7">
                  ...
                  <a
                    href="https://www.nexxontech.com/contact"
                    rel="noreferrer"
                    className="text-blue-700 underline"
                    target="_blank"
                  >
                    https://www.nexxontech.com/contact
                  </a>
                </p>
              </li>
              <li className="mb-4 leading-7">
                <p className="mb-4 leading-7">By phone number: 9695801074</p>
              </li>
            </ul>
          </div>
        </div>
